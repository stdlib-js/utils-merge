...
var P=require('@stdlib/assert-is-object/dist'),T=require('@stdlib/error-tools-fmtprodmsg/dist'),L=E();function Q(e){return r;function r(n){var a,t,o,i;if(a=arguments.length-1,a<1)throw new Error(format('1Vl1l'));if(!P(n))throw new TypeError(T('1Vl3L',n));for(o=new Array(a),i=0;i<a;i++){if(t=arguments[i+1],!P(t))throw new TypeError(T('1VlEY',i,t));o[i]=t}for(i=0;i<a;i++)L(n,o[i],e.level,e.copy,e.override,e.extend);return n}}F.exports=Q
